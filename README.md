...
- **Источник**: Kaggle, соревнование [Home Credit Default Risk](https://www.kaggle.com/competitions/home-credit-default-risk).
...
- `predict_proba(features)` возвращает вероятность дефолта,
- `predict(features, threshold)` возвращает класс по порогу.
